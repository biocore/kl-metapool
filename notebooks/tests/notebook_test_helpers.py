...
class TestNotebook(unittest.TestCase):
    ...
    def _run_notebook_test(self, run_params, out_param_details=None,
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            local_run_params = run_params.copy()
            local_run_params.pop(self._AUTOCONSTRUCTED_FPS_KEY, None)
            ...
            for curr_autogenerated_input_name in autogenerated_input_fps:
                original_fp = local_run_params[curr_autogenerated_input_name]
                ...
                # update local_run_params to point to temp file path
                local_run_params[curr_autogenerated_input_name] = str(temp_fp)
            # next curr_run_param_name

            # Populate local_run_params with formatted output paths and ensure
            ...
            for curr_out_param_name, curr_details in out_param_details.items():
                ...
                if not curr_details.get(self._AUTOCONSTRUCTED_KEY, False):
                    local_run_params[curr_out_param_name] = \
