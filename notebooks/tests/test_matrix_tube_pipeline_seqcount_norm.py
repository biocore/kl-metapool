...
class TestMatrixTubePipelineSeqcountNormNotebook(TestNotebook):
        ...
        run_params = {
            ...
            'sample_concs_fp':
                (f'{self.test_data_dir}/Quant/MiniPico/'
                 '2022_07_Celeste_Adaptation_16_17_18_21_gDNA_quant.txt'),
            ...
            'undiluted_gdna_conc_fp':
                (f'{self.test_data_dir}/Quant/MiniPico/2022_07_'
                 'Celeste_Adaptation_16_17_18_21_gDNA_quant.txt'),
            ...
            'lib_concs_fp':
                f'{self.test_data_dir}/Quant/MiniPico/2022_07_Celeste_'
                'Adaptation_16_17_18_21_CleanLib_quant.txt',
            ...
            'read_counts_fps': [
                (f'{self.test_data_dir}/Demux/YYYY_MM_DD_Celeste_'
                 'Adaptation_raw_counts.tsv'),
                (f'{self.test_data_dir}/Demux/YYYY_MM_DD_Celeste_'
                 'Marmoset_raw_counts.tsv'),
                (f'{self.test_data_dir}/Demux/'
                 'YYYY_MM_DD_TestProjB_raw_counts.tsv')
            ],
        ...
        output_params = {
            ...
            'norm_picklist_fp': {
                self._OUT_PARAM_VARIABLE_KEY:
                    ('{path}/Input_Norm/YYYY_MM_DD_Celeste_Adaptation_'
                     '16-21_inputnorm.txt'),
            ...
            'index_picklist_fp': {
                self._OUT_PARAM_VARIABLE_KEY:
                    ('{path}/Indices/YYYY_MM_DD_Celeste_Adaptation_16-21_'
                     'indices_matrix.txt'),
                self._FILE_PATH_KEY: True
            },
            ...
            'iseq_sample_sheet_fp': {
                self._OUT_PARAM_VARIABLE_KEY:
                    ('{path}/SampleSheets/YYYY_MM_DD_Celeste_Adaptation_'
                     '12986_16_17_18_21_matrix_samplesheet_iseq.csv'),
                self._FILE_PATH_KEY: True,
            ...
            'novaseq_sample_sheet_fp': {
                self._OUT_PARAM_VARIABLE_KEY:
                    ('{path}/SampleSheets/YYYY_MM_DD_Celeste_Adaptation_'
                     '12986_16_17_18_21_matrix_samplesheet_novaseq.csv'),
                self._FILE_PATH_KEY: True,
                self._ZERO_DATES_FUNC_KEY: self._replace_illumina_date
            },
            ...
            'iseqnormed_picklist_fp': {
                self._OUT_PARAM_VARIABLE_KEY:
                    ('{path}/Pooling/YYYY_MM_DD_Celeste_Adaptation_'
                     '16_17_18_21_iSeqnormpool.csv'),
                self._FILE_PATH_KEY: True
            }
        }
    ...
    def test_matrix_tube_pipeline_absquant_metag(self):
        ...
        output_params['syndna_picklist_fp'] = {
            self._OUT_PARAM_VARIABLE_KEY:
                ('{path}/Input_Norm/YYYY_MM_DD_Celeste_Adaptation_'
                 '16-21_matrix_syndna_absquant.txt'),
            self._FILE_PATH_KEY: True
        }
        ...
        output_params['plate_df_fp'] = {
            self._OUT_PARAM_VARIABLE_KEY:
                ('{path}/QC/YYYY_MM_DD_Celeste_Adaptation_'
                 'matrix_df_absquant.txt'),
            self._FILE_PATH_KEY: True
        }
        # Part 3 Step 7 outputs
        output_params['iseq_sample_sheet_fp'] = {
            self._OUT_PARAM_VARIABLE_KEY:
                ('{path}/SampleSheets/YYYY_MM_DD_Celeste_Adaptation_'
                 '12986_16_17_18_21_matrix_samplesheet_iseq_absquant.csv'),
            self._FILE_PATH_KEY: True,
            self._ZERO_DATES_FUNC_KEY: self._replace_illumina_date
        }
        output_params['novaseq_sample_sheet_fp'] = {
            self._OUT_PARAM_VARIABLE_KEY:
                ('{path}/SampleSheets/YYYY_MM_DD_Celeste_Adaptation_'
                 '12986_16_17_18_21_matrix_samplesheet_novaseq_absquant.csv'),
            self._FILE_PATH_KEY: True,
            self._ZERO_DATES_FUNC_KEY: self._replace_illumina_date
        }
