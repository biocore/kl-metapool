...
class TestAmpliconNotebook(TestNotebook):
    ...
    def test_amplicon_for_katharoseq(self):
        ...
        run_params = {
            ...
            'sample_accession_fp': (
                f"{self.test_data_dir}/Plate_Maps/"
                "2022_summer_Celeste_Adaptation_16_17_18_21_"
                "sa_file_for_katharoseq.tsv"
            ),
            'metadata_fp': (
                f"{self.test_data_dir}/Plate_Maps/"
                "12986_20230314-090655.txt"
            ...
            'compression_layout': [
                ...
                },
                {
                    ...
                    'Plate map file': (
                        f'{self.test_data_dir}/Plate_Maps/'
                        '2022_summer_Celeste_Adaptation_21_plate_map'
                        '_for_katharoseq.tsv'
                    ),
                    'Plate elution volume': '70',
            ...
            'well_col': 'Well',
            'blanks_dir': f'{self.test_data_dir}/BLANKS_for_katharoseq',
            'katharoseq_dir': f'{self.test_data_dir}/katharoseq',
            'files': [
                (f'{self.test_data_dir}/amplicon/'
                 '20230201_IL515fBC_806r_ABTX_11052_174_178_182_185_'
                 'MF_notebook_updated.txt')
        ...
        output_params = {
            'output_filename': {
                self._OUT_PARAM_VARIABLE_KEY:
                    ('{path}/amplicon/20230302_IL515fBC_806_Celeste_'
                     'Adaptation_12986_Plate_16_17_18_21_for_katharoseq.txt'),
                self._FILE_PATH_KEY: True,
            },
            'merged_output_filename': {
                self._OUT_PARAM_VARIABLE_KEY:
